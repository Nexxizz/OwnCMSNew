...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Mrz 2024 um 10:40
...
--
-- Tabellenstruktur für Tabelle `content_of_user`
--

CREATE TABLE `content_of_user` (
...
--
-- Indizes für die Tabelle `content_of_user`
--
ALTER TABLE `content_of_user`
  ADD PRIMARY KEY (`nutzerId`,`examplesId`);
